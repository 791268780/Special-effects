...
WScript.Echo("想结素我么?那你就再多点一次") 
WScript.Echo("想结素我么?那你就再多点一次") 
WScript.Echo("想结素我么?那你就再点最后一次") 
WScript.Echo("还有一次") 
WScript.Echo("真的是最后一次啦") 
WScript.Echo("没骗你吧，嘿嘿！") 